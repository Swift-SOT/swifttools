...
- _New class_: `Swift_GUANO`. This class and it's support classes allow for querying data generated by the _Gamma-Ray Urgent Archiver for Novel Opportunities_ (GUANO).
- _New class_: `Swift_Data`. This class makes downloading of Swift data from the USA and UK Swift Data Centers easy.
- _New class_: `Swift_Resolve`. For a give source name, this returns the coordinates as resolved by various name resolvers.
