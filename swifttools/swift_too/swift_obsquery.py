...
class Swift_AFST_Entry(TOOAPI_Baseclass):
    ...
    def __init__(self):
        ...
        # Entries
        self.rows = ['begin','settle','end','ra','dec','roll','targname','targetid','seg','ra_point','dec_point','xrt','uvot']
        self.begin = None
        self.settle = None
        self.end = None
        self.ra = None
...
class Swift_AFST(TOOAPI_Baseclass):
    ...
    def __init__(self,username=None,shared_secret=None,ra=None,dec=None,start=None,end=None,targetid=None,obsnum=None,radius=0.1967):
        TOOAPI_Baseclass.__init__(self)
        ...
        self.rows = ['username','start','end','ra','dec','radius','targetid','obsnum','entries']
