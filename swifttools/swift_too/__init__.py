'''The `swift_too` module provides a Python API that gives you almost everything
...
2. Swift_ObsQuery This class allows you to query what observations Swift has
